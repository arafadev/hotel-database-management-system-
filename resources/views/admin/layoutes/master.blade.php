...
<body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Hotel</a></div>
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            <a class="breadcrumb-item" href="{{ route('admin.hotel') }}">Hotel</a>
            <span class="breadcrumb-item active">@yield('subPath')</span>
        </nav>
