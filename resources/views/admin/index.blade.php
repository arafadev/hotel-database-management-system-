            ...
            <div class="col-sm-6 col-xl-3">
                <div class="card pd-20 bg-primary">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <span class="sparkline2"><canvas width="59" height="50"
                                style="display: inline-block; width: 59px; height: 50px; vertical-align: top;"></canvas></span>
        ...
        <div class="row row-sm mg-t-20">
            <div class="col-xl-8">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body pd-0">
                        <div id="rickshaw2" class="wd-100p ht-200 rickshaw_graph"><svg width="819" height="200">
                                <g>
                                    <path
                                        d="M0,39.99999999999999Q54.6,3.46666666666667,63,4.0000000000000036C75.6,4.800000000000004,113.4,40.400000000000006,126,48S176.4,77.6,189,80S239.4,76,252,72S302.4,35.199999999999996,315,39.99999999999999S365.4,108,378,120S428.4,160,441,160S491.4,126,504,120S554.4,106,567,100S617.4,58.00000000000001,630,60.00000000000001S680.4,122,693,120S743.4,41.99999999999999,756,39.99999999999999Q764.4,38.66666666666666,819,100L819,150Q764.4,119.33333333333333,756,120C743.4,121,705.6,159,693,160S642.6,131,630,130S579.6,147,567,150S516.6,157,504,160S453.6,180,441,180S390.6,166,378,160S327.6,122.4,315,120S264.6,134,252,136S201.6,141.2,189,140S138.6,127.8,126,124S75.6,102.4,63,102Q54.6,101.73333333333333,0,120Z"
                                        class="area" fill="#73a9e7"></path>
                                </g>
                                <g>
                                    <path
                                        d="M0,120Q54.6,101.73333333333333,63,102C75.6,102.4,113.4,120.2,126,124S176.4,138.8,189,140S239.4,138,252,136S302.4,117.6,315,120S365.4,154,378,160S428.4,180,441,180S491.4,163,504,160S554.4,153,567,150S617.4,129,630,130S680.4,161,693,160S743.4,121,756,120Q764.4,119.33333333333333,819,150L819,200Q764.4,200,756,200C743.4,200,705.6,200,693,200S642.6,200,630,200S579.6,200,567,200S516.6,200,504,200S453.6,200,441,200S390.6,200,378,200S327.6,200,315,200S264.6,200,252,200S201.6,200,189,200S138.6,200,126,200S75.6,200,63,200Q54.6,200,0,200Z"
                                        class="area" fill="#2B333E"></path>
                                </g>
                            </svg></div>
                    </div><!-- card-body -->
                </div><!-- card -->
                ...
                <div class="card pd-20 pd-sm-25 mg-t-20">
                    ...
                    <canvas id="chartBar4" height="375" width="961" style="display: block; height: 300px; width: 769px;"
            ...
            <div class="col-xl-4 mg-t-20 mg-xl-t-0">
                ...
                <div class="card pd-20 pd-sm-25">
                    ...
                    <p class="mg-b-20 mg-sm-b-30">Labels can be hidden if the slice is less than a given percentage of the
                        pie.</p>
                    <div id="flotPie2" class="ht-200 ht-sm-250" style="padding: 0px; position: relative;"><canvas
                            class="flot-base" width="437" height="312"
                            style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 350px; height: 250px;"></canvas><canvas
                            class="flot-overlay" width="437" height="312"
                            style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 350px; height: 250px;"></canvas><span
                            class="pieLabel" id="pieLabel1" style="position: absolute; top: 31px; left: 191.5px;">
                            <div style="font-size:8pt; text-align:center; padding:2px; color:white;">Series 2<br>11%</div>
                        </span><span class="pieLabel" id="pieLabel2"
                            style="position: absolute; top: 130px; left: 226.5px;">
                            <div style="font-size:8pt; text-align:center; padding:2px; color:white;">Series 3<br>32%</div>
                        </span><span class="pieLabel" id="pieLabel3"
                            style="position: absolute; top: 173px; left: 103.5px;">
                            <div style="font-size:8pt; text-align:center; padding:2px; color:white;">Series 4<br>25%</div>
                        </span><span class="pieLabel" id="pieLabel4"
                            style="position: absolute; top: 50px; left: 82.5px;">
                            <div style="font-size:8pt; text-align:center; padding:2px; color:white;">Series 5<br>29%</div>
                        </span></div>
                </div><!-- card -->
